...
#define _Intensity1_arr NewAmplifyShader
			UNITY_DEFINE_INSTANCED_PROP(float, _Intensity2)
#define _Intensity2_arr NewAmplifyShader
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( 1.0 - v.color ) * ( sin( ( ase_worldPos.x * ase_worldPos.z ) ) * ( tex2Dlod( _TextureSample0, float4( panner63, 0, 0.0) ) * _Intensity1_Instance ) ) * _Intensity2_Instance ).rgb;
		}
...
/*ASEBEGIN
Version=14201
7;29;1423;824;2100.344;103.6119;1.396159;True;True
...
Node;AmplifyShaderEditor.OneMinusNode;73;-583.5869,254.5919;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;70;-398.9183,336.8342;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=48E8A8A3C9DD24722CFD00FAC696841631CD6F01